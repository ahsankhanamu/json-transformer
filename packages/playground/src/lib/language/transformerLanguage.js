/**
 * JSON Transformer Language Definition
 * Auto-generates language features from the JSON Transformer library
 */

// Function definitions with metadata for autocomplete
// These are derived from @ahsankhanamu/json-transformer runtime helpers
export const functions = [
  ...
  },
  {
    ...
    syntax: 'replaceAll(str, find, replacement)',
    category: 'String',
  ...
  {
    name: 'padStart',
    desc: 'Pad string start',
    syntax: 'padStart(str, length, char)',
    category: 'String',
    insertText: 'padStart(',
  },
  {
  ...
  },
  {
    ...
    syntax: 'kebabCase(str)',
    category: 'String',
    insertText: 'kebabCase(',
  },
  ...
  },
  {
    name: 'omit',
    desc: 'Omit keys',
    syntax: 'omit(obj, ...keys)',
    category: 'Object',
    insertText: 'omit(',
  },
  {
    name: 'get',
    desc: 'Get nested path',
    syntax: 'get(obj, path, default?)',
    category: 'Object',
    insertText: 'get(',
  },
  {
    name: 'set',
    desc: 'Set nested path',
    syntax: 'set(obj, path, value)',
    category: 'Object',
    insertText: 'set(',
  },
  ...
  {
    name: 'isUndefined',
    desc: 'Check undefined',
    syntax: 'isUndefined(value)',
    category: 'Type',
  ...
  {
    name: 'toArray',
    desc: 'Convert to array',
    syntax: 'toArray(value)',
    category: 'Conversion',
    insertText: 'toArray(',
  },
  {
  ...
  },
  {
    ...
    syntax: 'parseDate(str)',
    category: 'Date',
    insertText: 'parseDate(',
  },
...
// Operators available in JSON Transformer expressions
...
// Keywords in JSON Transformer expressions
